...
An aspiring **Software Engineer** and **Cybersecurity Analyst** with a strong focus on building clean, test-driven applications, secure systems architecture, and managing agile technical projects. 

---

### 🚀 What I'm Up To
- 🔭 **Currently focusing on:** Advanced Python development, Systems Architecture, and Test-Driven Development (TDD).
- 🔐 **Cybersecurity & AI Security:** Actively working toward vendor-neutral security certifications and secure coding practices.
- ⚙️ **Project Management:** Applying Agile and Scrum methodologies to streamline software delivery.
